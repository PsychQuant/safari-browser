...
- [x] 1.1 Bounded current-window observation 與 Conservative pending-dialog absence：新增有界 AX 主視窗 context、共用 worker/scanner 的指定根視窗掃描及前後身分檢查；以 fake provider 驗證三態、他窗隔離、hidden/minimized 與可見性未知、錯誤／截斷、busy 與 800 ms 期限，並跑既有 scanner/worker/listing 回歸。
